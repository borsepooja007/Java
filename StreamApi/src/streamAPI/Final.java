...
public class Final {
	...
	public static void main(String[] args) {
		List<Fruit> fru = Arrays.asList(
				...
				new Fruit("Apple", 98, 45, "Red"), new Fruit("Banana", 101, 30, "Yellow"),
				new Fruit("Watermelon", 120, 55, "Red"), new Fruit("Blueberry", 78, 34, "Blue"));

		List<News> news1 = Arrays.asList(

				new News(22, "Sana", "meera", " Cororna cases Increasing"),
				new News(23, "ani", "pavan", "IPL Postponed"), new News(23, "vire", "neha", "UPSC Exam "),
				new News(24, "Ashish", "Narhsa", "exam Prepareation"),
				new News(22, "sayali", "yadnik", "New List OF Budget GDP Getiing Low"),
				new News(23, "tara", "lina", "Israil War"));
		List<Trader> Trade = Arrays.asList(

				new Trader("teju", "Pune"), new Trader("neha", "Mumbai"), new Trader("Amol", "Pune"),
				new Trader("Akash", "Delhi"), new Trader("Rohan", "Delhi"), new Trader("Sagar", "Pune"));
		List<Transaction> Tran = Arrays.asList(

				new Transaction(new Trader("meera", "Pune"), 2014, 40000),
				new Transaction(new Trader("neha", "Mumbai"), 2012, 21000),
				new Transaction(new Trader("Akash", "Delhi"), 2019, 70000),
				new Transaction(new Trader("Amol", "Pune"), 2017, 22222),
				new Transaction(new Trader("Rohan", "Delhi"), 2014, 19899),
				new Transaction(new Trader("Sagar", "Pune"), 2015, 17050));
